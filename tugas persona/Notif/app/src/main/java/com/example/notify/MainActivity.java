...
import com.example.notify.task_database.TaskContract;
import com.example.notify.task_database.TaskDatabaseHelper;
        ...
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        .setTitle("Tambah Tugas Baru").setView(taskEdit)
